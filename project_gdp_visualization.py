...
def read_csv_as_nested_dict(name, keyfield, separator, quote): #读取原始csv文件的数据，格式为嵌套字典
    """
    输入参数:
      name:csv文件名
      keyfield:键名
...
def test_render_world_map(year):  #测试函数
    ...
    对各功能函数进行测试
    """
    gdpinfo = {"gdpfile": "isp_gdp.csv","separator": ",","quote": '"',"min_year": 1960,"max_year": 2015,"country_name": "Country Name","country_code": "Country Code"} #定义数据字典
